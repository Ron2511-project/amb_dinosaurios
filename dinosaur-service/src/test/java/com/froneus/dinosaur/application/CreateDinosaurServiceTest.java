...
class CreateDinosaurServiceTest {
    ...
    void setUp() {
        ...
        service    = new CreateDinosaurService(repository);
    }

    @Test
    void execute_shouldSaveAndReturnDinosaurWithAliveStatus() {
        ...
        when(repository.save(any())).thenAnswer(inv -> {
            // Simula lo que hace Postgres con BIGSERIAL
    ...
    void execute_shouldThrowWhenNameIsDuplicated() {
        ...
        assertThatThrownBy(() -> service.execute(cmd))
                ...
                .hasMessage("El nombre del dinosaurio ya existe");
